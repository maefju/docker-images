...
#./setupPcw.sh
cp ~/linuxgsm/csgo/. ~/linuxgsm/serverfiles/csgo/ -Rv

echo 'bot_quota 0' >> ~/linuxgsm/serverfiles/csgo/cfg/gamemode_competitive.cfg
echo 'bot_join_after_player 0' >> ~/linuxgsm/serverfiles/csgo/cfg/gamemode_competitive.cfg
...
echo 'sleep for orangebot'
sleep 10s
echo 'start organebot'
./orangebot/orangebot-runner.sh
